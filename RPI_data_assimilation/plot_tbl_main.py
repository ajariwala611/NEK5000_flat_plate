...
def view1(cam):
    cam.SetPosition(5,6.5,16.5)     # Camera position
    cam.SetFocalPoint(5,1.5,5.5)    # Camera focal point
    #cam.SetViewUp(0,0,-1)
    # cam.Elevation(0)
    # cam.Yaw(0)
    # cam.Roll(0)
...
#   reader =  OpenDataFile('/Volumes/ResearchDat/nek5000/Nek5000/run/turbulent_flow_control/turbulent_boundary_layer/statistics/flat_plate.nek5000')
    ...
    if args.slice1:
        ...
        slice1 = Slice(gradient)
        slice1.SliceType = 'Plane'
        slice1.SliceType.Normal = [0,1,0]
        slice1.SliceType.Origin = [5,0.01,5.5]
    ...
    if args.slice2:
        ...
        slice2.SliceType.Origin = [0.01,1.5,5.5]
